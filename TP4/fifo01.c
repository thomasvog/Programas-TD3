...
// Al descomentar las ultimas dos lineas, se elimina la FIFO produciendo que
// al revisar el directorio tmp, no exista la FIFO previamente creada.

// Al aplicar el O_NONBLOCK, se produce la desincronizacion de la FIFO
// por lo que el padre obtiene error al abrir la FIFO y
// el hijo termina antes de escribir en pantalla lo leido.