...
// El objetivo de este programa es el mismo que el de mutex01

// En este caso el resultado es siempre el esperado porque se ha utilizado mutex
// para que ningun hilo pueda interferir en la ejecucion de otro.